...
def is_last_message_from_sender(chat_log, sender_name="<The Senders Name should be here>"):
...
while True:
    ...
    if is_last_message_from_sender(chat_history):
        ...
        messages=[
            ...
            {"role": "system", "content": "Do not start like this [21:02, 12/6/2024] <The Senders' Name will be here>: "},
